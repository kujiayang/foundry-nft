...
// tests both deployer and moodnft contracts
contract MoodNftIntegrationsTest is Test {
    ...
    string public constant SAD_SVG_URI = "data:application/json;base64,";
    ...
    function testViewTokenUriIntegration() public {
        vm.prank(USER); // so that the NFT goes to an address, openzeppelin prevents NFTs from being transferred to unretrievable contracts
        moodNft.mintNft();
    ...
    function testFlipTokenToSad() public {
        ...
        vm.prank(USER);
        moodNft.flipMood(0);
        // assertEq prints out both values, assert only prints one
